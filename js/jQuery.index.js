...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _createNode: function (node, parentLiNode) {
            ...
            var nodeLiElements = '<li id="' + node.id + '" class="tnode" >' + beforeDiv + '<div class="trcont"><div class="ui-widget-header ui-corner-tl ui-corner-tr"><img class="node-head-img" src="'+node.photo+'" alt="">' +
